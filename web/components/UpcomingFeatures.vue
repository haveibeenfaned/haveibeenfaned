<template>
  ...
  <pre class="text-slate-300 font-bold pl-5">
...
Top 10 Upcoming Features:
  ...
  <ol class="pl-20 list-decimal text-slate-300 font-mono md:text-base sd:text-sm">
    ...
    <li>Support for identifying actual P*** pages</li>
    <li>Profiles, badges and Weekly / Monthly Leaderboard</li>
    <li>Support for linking Old / Inactive / Deleted Handles to New Handles</li>
